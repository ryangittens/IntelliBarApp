...
.factory('AuthenticationService',
    ...
    function (Base64, $http, $cookieStore, $rootScope, $timeout, $window) {
        ...
        service.CreateUser = function (email, password, callback){
            ...
            spark.createUser(email, password, create);
        };
 
        service.Login = function (username, password, callback) {
               var func = function(err, body) {
                var response = {};
                $timeout(function(){ 
                if (err){
                    console.log(err)    
                ...
                response = {success: true, token: body.access_token};
                console.log('API call login completed on callback:', body);
                }  
               callback(response);
               }, 1000);
            };
            spark.login({username: username, password: password},func); 
        };
