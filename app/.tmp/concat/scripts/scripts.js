 ...
 */
angular.module('intelliBarApp').controller('MainCtrl', [
  '$scope',
  function ($scope) {
  }
]);
 ...
 * Controller of the intelliBarApp
 */
angular.module('intelliBarApp').controller('SparkCtrl', [
  '$scope',
  '$rootScope',
  '$timeout',
  '$location',
  function ($scope, $rootScope, $location, $timeout) {
    $rootScope.setBar = function (barIndex) {
      console.log('selectedBar = selected');
      if ($rootScope.selectedBar != barIndex) {
    ...
    var loadBars = function (barIndex) {
      ...
      devicesPr.then(function (data) {
        ...
        var bars = data;
        //var bars = [{name: 'bar1', connected: false},{name: 'bar2', connected: false}];
        $rootScope.bars = bars;
        if (barIndex) {
          loadBarObj(barIndex);
        } else {
    ...
    var loadRelayStatus = function (i) {
      $rootScope.bars[i].relayStatus = [
        0,
        0,
        0,
        0
      ];
      $rootScope.bars[i].getVariable('RelayStatus', function (err, data) {
        if (err) {
          $scope.dataLoading = false;
          $rootScope.bars[i].connected = false;
          $scope.$digest();
          console.log('An error occurred while getting attrs:', err);
        } else {
          $scope.dataLoading = false;
          console.log('Core attr retrieved successfully:', data);
          console.log(data.result.charAt(0));
          for (var j = 0; j < 4; j++) {
          ...
          console.log($rootScope.bars[i].relayStatus);
          $scope.$digest();
          sparkUpdate();
        }
      });
    };
    var sparkUpdate = function () {
      $rootScope.bars[0].getVariable('minute', function (err, data) {
        if (err) {
          console.log('An error occurred while getting attrs:', err);
        } else {
          console.log('Core attr retrieved successfully:', data);
    ...
    $scope.outletSwitch = function (outn, newValue, deviceID) {
      ...
      var requestURL2 = 'https://api.spark.io/v1/devices/' + deviceID + '/' + setFunc + '/';
      $.post(requestURL2, {
        params: paramStr,
        access_token: accessToken
      });
    };
    $rootScope.loadSpark = function (barIndex) {
      loadBars(barIndex);
    };
  }
]);
 ...
 * Controller of the intelliBarApp
 */
angular.module('intelliBarApp').controller('DashCtrl', [
  '$scope',
  '$rootScope',
 ...
 * Controller of the intelliBarApp
 */
angular.module('intelliBarApp').controller('NavController', [
  '$scope',
  '$mdSidenav',
  '$location',
  '$rootScope',
 ...
 * Controller of the intelliBarApp
 */
angular.module('intelliBarApp').controller('OutletsCtrl', [
  '$scope',
  '$filter',
  ...
  function (Base64, $http, $cookieStore, $rootScope, $timeout, $window) {
    ...
    service.Login = function (username, password, callback) {
      ...
      spark.login({
        username: username,
        password: password
      }, func);  /* Use this for real authentication
             ----------------------------------------------*/
